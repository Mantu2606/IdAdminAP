        ...
        public async Task<IActionResult> UploadExcel(IFormFile file)
        {
            ...
            using (var stream = new MemoryStream())
            {
                ...
                using (SpreadsheetDocument doc = SpreadsheetDocument.Open(stream, false))
                {
                    ...
                    var existingStudents = _dbContext.Students.ToDictionary(s => s.EnrollNo); // Eagerly load existing students into a dictionary
            ...
            return Ok(students); // Return the students without saving them to the database
        }
